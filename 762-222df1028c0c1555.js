  ...
  [762],
  {
    10538: function (t, e, r) {
      ...
      var h =
        ...
        void 0 === window.document.createElement
          ...
          : function (t, e) {
              var r = e(),
                s = i({ inst: { value: r, getSnapshot: e } }),
                n = s[0].inst,
                a = s[1];
              return (
                o(
      ...
      class c extends u.l {
        ...
        createResult(t, e) {
          ...
          if (
            ...
            (g = p.data), (v = p.dataUpdatedAt), (m = p.status), (E = !0);
            ...
            if (
              ...
              try {
                (this.selectFn = e.select),
                  (g = e.select(y.data)),
                  (g = (0, s.oE)(null == i ? void 0 : i.data, g, e)),
                  (this.selectResult = g),
                  (this.selectError = null);
              } catch (T) {
                this.selectError = T;
          ...
          if (void 0 !== e.placeholderData && void 0 === g && "loading" === m) {
            ...
            void 0 !== w &&
              ((m = "success"),
              (g = (0, s.oE)(null == i ? void 0 : i.data, w, e)),
              (Q = !0));
          }
          this.selectError &&
            ((R = this.selectError),
            ...
            t.onSuccess
              ? (null == (e = (r = this.options).onSuccess) ||
                ...
                null == (s = (n = this.options).onSettled) ||
                  s.call(n, this.currentResult.data, null))
              : t.onError &&
                (null == (i = (u = this.options).onError) ||
                  i.call(u, this.currentResult.error),
                null == (o = (c = this.options).onSettled) ||
                  o.call(c, void 0, this.currentResult.error)),
              t.listeners &&
    ...
    52696: function (t, e, r) {
      ...
      var s = r(70079),
        ...
        a = r(86857);
      function h(t, e) {
        let r = (0, o.NL)({ context: t.context }),
          h = (0, c.S)(),
          d = (0, u._)(),
        ...
        if (
          ((0, n.$)(
            s.useCallback(
              (t) => (h ? () => void 0 : p.subscribe(i.V.batchCalls(t))),
              [p, h]
            ),
            () => p.getCurrentResult(),
            () => p.getCurrentResult()
