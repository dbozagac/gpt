...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [264],
  {
    ...
    33264: function (e, t, n) {
      ...
      var l = n(34388),
        p = n(49674),
        f = "https://chat.openai.com/backend-api",
        g = ["cf-ipcountry"],
        y = (function () {
          function e() {
            (0, i.Z)(this, e);
          ...
          return (
                ...
                return (0, h.__generator)(this, function (h) {
                  switch (h.label) {
                    case 0:
                      return [
                        4,
                        fetch(e, (o = (0, s.Z)({ credentials: "include" }, t))),
                      ];
                    case 1:
                      if ((a = h.sent()).status >= 500) throw new p.kb();
            ...
            (e.upload = function (e, t) {
              ...
              return (
                n.append("file", t),
                this.fetch(
                  "".concat(f, "/conversation/").concat(e, "/upload"),
                  {
                    method: "POST",
            ...
            (e.fetchFileForDownload = function (e, t) {
              ...
              return fetch(
                ""
                  .concat(f, "/conversation/")
                  .concat(e, "/download?")
                  .concat(n),
                { method: "GET", headers: (0, s.Z)({}, this.getAuthHeader()) }
              );
            }),
            ...
            (e.generateTitle = function (e, t, n) {
              return this.fetch(
                "".concat(f, "/conversation/gen_title/").concat(e),
                {
                  method: "POST",
                  headers: (0, s.Z)(
                    { "Content-Type": "application/json" },
                    ...
                    (0, u.L)(
                      ...
                      ),
                      {
                        ...
                        onmessage: function (e) {
                          if ("[DONE]" === e.data)
                            i.abort(), t({ finish_reason: "stop" });
                          else if ("ping" === e.event);
                          else
                            try {
                              var n = JSON.parse(e.data);
                              if (n.error) throw new p.kb(n.error.message);
                              t({
                                message: n.message,
                                threadId: n.conversation_id,
                              });
                            } catch (o) {
                              if ((0, l.T)(o)) throw new p.kb(o.message);
                            }
                        },
                        onerror: function (e) {
                          throw (
            ...
            (e.submitMessageFeedback = function (e) {
              return this.fetch(
                "".concat(f, "/conversation/message_feedback"),
                {
                  method: "POST",
                  headers: (0, s.Z)(
                    { "Content-Type": "application/json" },
            ...
            (e.submitMessageComparisonFeedback = function (e) {
              return this.fetch(
                "".concat(f, "/conversation/message_comparison_feedback"),
                {
                  method: "POST",
                  headers: (0, s.Z)(
                    { "Content-Type": "application/json" },
            ...
            (e.getPlugins = function (e) {
              ...
              var y = new URLSearchParams(r);
              return this.fetch("".concat(f, "/aip/p?").concat(y), {
                method: "GET",
                headers: (0, s.Z)(
                  { "Content-Type": "application/json" },
            ...
            (e.updatePluginUserSettings = function (e) {
              var t = e.pluginId,
                ...
                o = e.accessToken;
              return this.fetch(
                "".concat(f, "/aip/p/").concat(t, "/user-settings"),
                {
                  method: "PATCH",
                  headers: (0, s.Z)(
                    { "Content-Type": "application/json" },
            ...
            (e.setPluginUserHttpToken = function (e) {
              var t = e.id,
                ...
                o = e.accessToken;
              return this.fetch(
                "".concat(f, "/aip/p/").concat(t, "/user-settings/http-auth"),
                {
                  method: "POST",
                  headers: (0, s.Z)(
                    { "Content-Type": "application/json" },
            ...
            (e.setPluginServiceHttpToken = function (e) {
              var t = e.id,
                ...
                o = e.accessToken;
              return this.fetch(
                "".concat(f, "/aip/p/").concat(t, "/http-auth"),
                {
                  method: "POST",
                  headers: (0, s.Z)(
                    { "Content-Type": "application/json" },
            ...
            (e.getAccountStatus = function (e, t) {
                ...
                try {
                  for (
                    ...
                    var d = (0, c.Z)(h.value, 2),
                      l = d[0],
                      p = d[1];
                    g.includes(l.toLowerCase()) && (o[l] = p);
                  }
                } catch (y) {
                  (a = !0), (r = y);
                } finally {
              ...
              return this.fetch("".concat(f, "/accounts/check"), {
                method: "GET",
                headers: n,
              });
            }),
